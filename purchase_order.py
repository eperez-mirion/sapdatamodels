...
# MAGIC %md
# MAGIC # SAP Purchase Orders Report
# MAGIC **Source:** `median_hub_captured.sap`
# MAGIC
# MAGIC **Tables Used:**
# MAGIC | Table | Description | Role |
# MAGIC |-------|-------------|------|
# MAGIC | EKKO  | Purchasing Document Header | One row per PO — provides document type, vendor, currency, date, purchasing org/group, company code |
...
# MAGIC
# MAGIC **Join logic:**
# MAGIC - EKKO is the base (PO header), filtered to document numbers 0004000000–0004999999 (standard POs).
# MAGIC   Stock Transfer Orders (0003xxxxxx) are handled in `stock_transfer.py`.
...
# MAGIC
# MAGIC **Mirrors:** SAP ME2M transaction
# MAGIC
